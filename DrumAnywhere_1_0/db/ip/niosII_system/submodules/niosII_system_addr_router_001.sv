...
(
    ...
    localparam PAD17 = log2ceil(64'h1909108 - 64'h1909100);
    localparam PAD18 = log2ceil(64'h1909110 - 64'h1909108);
    localparam PAD19 = log2ceil(64'h1909112 - 64'h1909110);
    // -------------------------------------------------------
    ...
    always @* begin
        ...
        // ( 0x1909108 .. 0x1909110 )
        if ( {address[RG:PAD18],{PAD18{1'b0}}} == 25'h1909108 ) begin
            src_channel = 20'b00000000000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
        end

        // ( 0x1909110 .. 0x1909112 )
        if ( {address[RG:PAD19],{PAD19{1'b0}}} == 25'h1909110 ) begin
