...
(
    ...
    localparam PAD15 = log2ceil(64'h19090f0 - 64'h19090e0);
    localparam PAD16 = log2ceil(64'h1909100 - 64'h19090f0);
    localparam PAD17 = log2ceil(64'h1909110 - 64'h1909100);
    localparam PAD18 = log2ceil(64'h1909118 - 64'h1909110);
    localparam PAD19 = log2ceil(64'h1909120 - 64'h1909118);
    localparam PAD20 = log2ceil(64'h1909122 - 64'h1909120);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1909122;
    ...
    always @* begin
        ...
        // ( 0x19090e0 .. 0x19090f0 )
        if ( {address[RG:PAD15],{PAD15{1'b0}}} == 25'h19090e0 ) begin
            src_channel = 21'b000000001000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
        end

        // ( 0x19090f0 .. 0x1909100 )
        if ( {address[RG:PAD16],{PAD16{1'b0}}} == 25'h19090f0 ) begin
            src_channel = 21'b000000000100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
        end

        // ( 0x1909100 .. 0x1909110 )
        if ( {address[RG:PAD17],{PAD17{1'b0}}} == 25'h1909100 ) begin
        ...
        // ( 0x1909118 .. 0x1909120 )
        if ( {address[RG:PAD19],{PAD19{1'b0}}} == 25'h1909118 ) begin
            src_channel = 21'b000000000000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
        end

        // ( 0x1909120 .. 0x1909122 )
        if ( {address[RG:PAD20],{PAD20{1'b0}}} == 25'h1909120 ) begin
