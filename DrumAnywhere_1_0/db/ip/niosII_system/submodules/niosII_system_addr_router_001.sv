...
(
    ...
    localparam PAD13 = log2ceil(64'h11090d8 - 64'h11090d0);
    localparam PAD14 = log2ceil(64'h11090e0 - 64'h11090d8);
    localparam PAD15 = log2ceil(64'h11090e2 - 64'h11090e0);
    // -------------------------------------------------------
    ...
    always @* begin
        ...
        // ( 0x11090d8 .. 0x11090e0 )
        if ( {address[RG:PAD14],{PAD14{1'b0}}} == 25'h11090d8 ) begin
            src_channel = 16'b0000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
        end

        // ( 0x11090e0 .. 0x11090e2 )
        if ( {address[RG:PAD15],{PAD15{1'b0}}} == 25'h11090e0 ) begin
