...
(
    ...
    localparam PAD12 = log2ceil(64'h1909088 - 64'h1909080);
    localparam PAD13 = log2ceil(64'h1909090 - 64'h1909088);
    localparam PAD14 = log2ceil(64'h1909092 - 64'h1909090);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1909092;
    ...
    always @* begin
        ...
        // ( 0x1909088 .. 0x1909090 )
        if ( {address[RG:PAD13],{PAD13{1'b0}}} == 25'h1909088 ) begin
            src_channel = 15'b000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
        end

        // ( 0x1909090 .. 0x1909092 )
        if ( {address[RG:PAD14],{PAD14{1'b0}}} == 25'h1909090 ) begin
