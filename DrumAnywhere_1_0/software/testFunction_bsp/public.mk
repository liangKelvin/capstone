...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DrumAnywhere_1_0.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11090b8
SOPC_SYSID_FLAG += --sidp=0x11090b8
ELF_PATCH_FLAG  += --sidp 0x11090b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1488579771
SOPC_SYSID_FLAG += --timestamp=1488579771
ELF_PATCH_FLAG  += --timestamp 1488579771
