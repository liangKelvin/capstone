...
#
nios2-flash-programmer "../flash/capstone_NonVolatile_generic_tristate_controller_0.flash" --base=0x1400000 --sidp=0x19090C8 --id=0x0 --accept-bad-sysid --device=1 --instance=0 '--cable=USB-Blaster on localhost [2-1.8]' --program 
