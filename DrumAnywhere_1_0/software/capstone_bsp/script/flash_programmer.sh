...
#
nios2-flash-programmer "../flash/capstone_generic_tristate_controller_0.flash" --base=0x0 --sidp=0x11090B8 --id=0x0 --timestamp=1489441364 --device=1 --instance=0 '--cable=USB-Blaster on localhost [2-1.6]' --program 
